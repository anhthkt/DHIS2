...
for (let i = 0; i < 100; i++) {
    ...
    let mKetquaDieuTri = `${getRandomInt(1, 2)}`
    let mThuoc = `Thuoc 1\nThuoc 2\nThuoc 3`
    ...
    let mHATTr = `${getRandomInt(10,150)}`
    let mHATT = `${parseInt(mHATTr) + getRandomInt(10,100)}`
    let mCanNang = `${getRandomInt(39, 100)}`
    let mChieuCao = `${getRandomInt(130, 185)}`
    let mVongEo = `${getRandomInt(55, 100)}`
    let mHanhVi = `${getRandomInt(0,2)}`
    let mCholesterol = `${getRandomInt(3,7)}`
    let mHDL = `${getRandomInt(0, 3)}`
    let mLDL = `${getRandomInt(0, 5)}`
    let mTri = `${getRandomInt(0, 6)}`
                ...
                "events": [
                    {
                        ...
                        "status": "COMPLETED",
                        "storedBy": "anhth",
                        "programStage": "Uj4blbvlb9K", //KLNKhac - Quản lý điều trị
                        "dataValues": [
                            {
                                "dataElement": "iXw1Eq7HqjS", //"name": "Phân loại bệnh nhân",
                                    "value": mPhanLoaiBenhNhan
                            },
                            {
                                "dataElement": "JsS4JQHaQoj", //"name": "Phân loại bệnh không lây nhiễm khác",
                                    "value": mPhanLoaiBenh
                            },
                            {
                                "dataElement": "Jyj6gzV9qec", //"name": "Kết quả điều trị bệnh KLN khác",
                                    "value": mKetquaDieuTri
                            },
                            {
                                "dataElement": "oJSfJMdymny", //"name": "Thuốc bệnh KLN khác",
                                    "value": mThuoc
                            },
                            {
                                "dataElement": "p3qT2PpuLFS", //"name": "Ngày phát hiện",
                                    "value": mNgayPhatHien
                            },
                            {
                                "dataElement": "DFHdfkyZaZO", //"name": "Nơi phát hiện",
                                    "value": mNoiPhatHien
                            },
                            {
                                "dataElement": "mVdtFRM2gFX", //"name": "Nhận xét/lời dặn",
                                    "value": mNhanXet
                            },
                            {
                                "dataElement": "mOguWgQg1or", //"name": "Y bác sĩ khám bệnh",
                                    "value": mYBacSy
                            },
                            {
                                "dataElement": "iedBhc5hNku", //"name": "Huyết áp tâm thu",
                                    "value": mHATT
                            },
                            {
                                "dataElement": "vig6FKWLnu7", //"name": "Huyết áp tâm trương",
                                    "value": mHATTr
                            },
                            {
                                "dataElement": "G7CZ83GipKS", //"name": "Cân nặng",
                                    "value": mCanNang
                            },
                            {
                                "dataElement": "oXwh2J3F8ql", //"name": "Chiều cao",
                                    "value": mChieuCao
                            },
                            {
                                "dataElement": "mfqPfxGZ8c8", //"name": "Vòng eo",
                                    "value": mVongEo
                            },
                            {
                                "dataElement": "G6kqlsUyuQe", //"name": "Hút thuốc lá ",
                                    "value": mHutThuocLa
                            },
                            {
                                "dataElement": "vVs8M3PXMX1", //"name": "Mức độ uống rượu, bia",
                                    "value": mMucDoRuouBia
                            },
                            {
                                "dataElement": "RKGwWCwiHWO", //"name": "Có đang thực hành ăn giảm muối không",
                                    "value": mHanhVi
                            },
                            {
                                "dataElement": "IBFOL0bTZoY", //"name": "Có ăn đủ 5 đơn vị hay 400g rau và trái cây/ngày không",
                                    "value": mHanhVi
                            },
                            {
                                "dataElement": "KFQhr1CkqQK", //"name": "Hoạt động thể lực đủ/nhiều hơn mức khuyến nghị không",
                                    "value": mHanhVi
                            },
                            {
                                "dataElement": "X0kBm02Gyft", //"name": "Biến chứng",
                                    "value": mBienChung
                            },
                            {
                                "dataElement": "ndg4B889111", //"name": "Cholesterol toàn phần",
                                    "value": mCholesterol
                            },
                            {
                                "dataElement": "udwtZvJMnVL", //"name": "Chẩn đoán",
                                    "value": mChanDoan
                            },
                            {
                                "dataElement": "hfGTym6BfK1", //"name": "Ghi rõ biến chứng",
                                    "value": mGhiRoBienChung
                            },
                            {
                                "dataElement": "X1sJxFHNvWO", //"name": "HDL",
                                    "value": mHDL
                            },
                            {
                                "dataElement": "UiodmaCcmH5", //"name": "LDL",
                                    "value": mLDL
                            },
                            {
                                "dataElement": "jWBytWfQ6uo", //"name": "Triglyceride",
                                    "value": mTri
                            }
                        ]
                    }
...
_writeJsonFile('tei-klnkhac.json', resultTei)
...
//     teiInfo = `INSERT INTO public.trackedentityinstance (trackedentityinstanceid, uid, code, created, lastupdated, lastupdatedby, createdatclient, lastupdatedatclient, inactive, deleted, lastsynchronized, featuretype, coordinates, organisationunitid, trackedentitytypeid, geometry, storedby) VALUES (${teiId}, '${uId}', null, '2021-07-11 01:11:25.342000', '2021-07-11 01:11:25.342000', 598, '2021-07-11 01:11:25.342000', '2021-07-11 01:11:25.342000', false, false, '1970-01-01 00:00:00.000000', null, null, ${orgId}, 381, null, 'anhth');
//     INSERT INTO public.trackedentityattributevalue (trackedentityinstanceid, trackedentityattributeid, created, lastupdated, value, encryptedvalue, storedby) VALUES (${teiId}, 357, '2021-05-24T00:31:15.976Z', '2021-05-24T00:31:15.977Z', ${mCMT}, null, 'anhth');
//     INSERT INTO public.trackedentityattributevalue (trackedentityinstanceid, trackedentityattributeid, created, lastupdated, value, encryptedvalue, storedby) VALUES (${teiId}, 358, '2021-05-24T00:31:15.976Z', '2021-05-24T00:31:15.977Z', '${mFullName}', null, 'anhth');
//     INSERT INTO public.trackedentityattributevalue (trackedentityinstanceid, trackedentityattributeid, created, lastupdated, value, encryptedvalue, storedby) VALUES (${teiId}, 359, '2021-05-24T00:31:15.976Z', '2021-05-24T00:31:15.977Z', '${mSex}', null, 'anhth');
//     INSERT INTO public.trackedentityattributevalue (trackedentityinstanceid, trackedentityattributeid, created, lastupdated, value, encryptedvalue, storedby) VALUES (${teiId}, 363, '2021-05-24T00:31:15.976Z', '2021-05-24T00:31:15.977Z', '${mBirthDay}', null, 'anhth');
//     INSERT INTO public.trackedentityattributevalue (trackedentityinstanceid, trackedentityattributeid, created, lastupdated, value, encryptedvalue, storedby) VALUES (${teiId}, 364, '2021-05-24T00:31:15.976Z', '2021-05-24T00:31:15.977Z', '${mAddress}', null, 'anhth'); \n`
