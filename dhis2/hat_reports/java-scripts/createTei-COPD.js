...
for (let i = 0; i < 2; i++) {
    ...
    let mPhanLoaiBenhCOPD_HEN = `${getRandomInt(1, 2)}`
    ...
    let mNgayPhatHien = ''
    let mNoiPhatHien = ''
    if(mPhanLoaiBenhNhan == 0 || mPhanLoaiBenhNhan == 1){
                ...
                "events": [
                    {
                        ...
                        "status": "COMPLETED",
                        "storedBy": "duylp",
                        "programStage": "eIIiN9bCK0D",
                        "dataValues": [
                            {
                                "dataElement": "iXw1Eq7HqjS",
                                "value": mPhanLoaiBenhNhan
                            },
                            {
                                "dataElement": "x1YOrvHDgek",
                                "value": mKetquaDieuTri
                            },
                            {
                                "dataElement": "kwmNWt51frC",
                                "value": mThuoc
                            },
                            {
                                "dataElement": "rIVl8YPZrW1",
                                "value": mPhanLoaiBenhCOPD_HEN
                            },
                            {
                                "dataElement": "p3qT2PpuLFS",
                                "value": mNgayPhatHien
                            },
                            {
                                "dataElement": "DFHdfkyZaZO",
                                "value": mNoiPhatHien
                            },
                            {
                                "dataElement": "G6kqlsUyuQe",
                                "value": mHutThuocLa
                            },
                            {
                                "dataElement": "qP2JSpTIP8V",
                                "value": mMucDoKhoThomMRC
                            },
                            {
                                "dataElement": "VVrV0g5UtR3",
                                "value": mDiemCAT
                            },
                            {
                                "dataElement": "gXBZFnSzFlP",
                                "value": mLuuLuongDinh
                            },
                            {
                                "dataElement": "QtVK4dZMCDt",
                                "value": mMucDoKhoTho
                            },
                            {
                                "dataElement": "be1BbXNkuPD",
                                "value": mLamViecSinhHoat
                            },
                            {
                                "dataElement": "R9ZarnuuMbs",
                                "value": mSoDotCap
                            },
                            {
                                "dataElement": "mOguWgQg1or",
                                "value": mYBacSy
                            },
                            {
                                "dataElement": "mVdtFRM2gFX",
                                "value": mNhanXet
                            },
                            {
                                "dataElement": "udwtZvJMnVL",
                                "value": mChanDoan
                            },
                            {
                                "dataElement": "X0kBm02Gyft",
                                "value": mBienChung
                            },
                            {
                                "dataElement": "hfGTym6BfK1",
...
_writeJsonFile('tei-copd.json', resultTei)
