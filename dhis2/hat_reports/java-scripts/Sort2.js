...
axios.get('http://daotao.tkyt.vn/api/analytics.json?dimension=dx:TjsrDy8W8h3;TyqF8uBkL7B;CR18qa3xmiF;RRnKZsIUweW;S4NScJXJ0Bx;U5RaHHmpAFs;ChgePBcK76w;mzyg9Os6CYe;TgPeB3Q82Az;PFBtIcnqhNV&dimension=ou:OU_GROUP-Gut8QH9va65;d5GgtJKn0Px&dimension=pe:202001;202002;202003;202004;202005;202006;202007;202008;202009;202010;202011;202012&hierarchyMeta=true', {
    auth: {
        username: 'diepvt',
        password: '1234567@A'
    }
...
function exportResult (res){
    ...
    fs.writeFile('results-2.html', header, function (err) {
        if (err) throw err;
    ...
    data.forEach(e => {
        ...
        fs.appendFile('results-2.html', body, function (err) {
            if (err) throw err;
            console.log('Exported!');
        })
    });

    fs.appendFile('results-2.html', footer, function (err) {
        if (err) throw err;
        console.log('Exported!');
    })
}