...
async function main() {
    ...
    const urlApi = `${url}/api/29/analytics/events/query/uX3pS8aZHN2.json?dimension=pe:THIS_MONTH;LAST_MONTH;LAST_3_MONTHS&dimension=ou:ZJAerHIZ8Ch&dimension=qgYbmBm4kx8.fcbbx6y83mn&stage=qgYbmBm4kx8&displayProperty=SHORTNAME&totalPages=false&outputType=EVENT&desc=qgYbmBm4kx8.fcbbx6y83mn&pageSize=1000&page=1`;
